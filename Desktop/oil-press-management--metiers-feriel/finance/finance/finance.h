...
public:
    explicit TransactionTab(int userId, QWidget *parent = nullptr);
    ~TransactionTab();
...
private slots:
    ...
    void onCategorieChanged(const QString &categorie);
    void rechercher();        // Nouveau
    void trier();             // Nouveau
    void exportTransaction(); // Nouveau
    void exportTxt();         // Export TXT
    void exportExcel();       // Export Excel
    void exportPDF();         // Export PDF
...
private:
    ...
    // Widgets - Recherche/Tri/Export
    QComboBox *cbSearchType;
    QComboBox *cbSearchCategorie;
    ...
    int currentUserId;  // ID de l'employé connecté
};
...
private:
    ...
    QLabel *lblBenefice;
    QLabel *lblPercRevenus;
    QLabel *lblPercDepenses;
    QLabel *lblTauxRentabilite;
...
public:
    Finance(int userId, QWidget *parent = nullptr);
    ~Finance();
