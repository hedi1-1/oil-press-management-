...
void menu::onFinanceManagementClicked()
{
    ...
    // TODO: Passer le userId de l'employé connecté depuis le système de login
    int userId = 1;  // Placeholder - à remplacer avec l'utilisateur réel
    
    if (!financeWindow) {
        financeWindow = new Finance(userId);
        // Connect the back signal to show this menu again
