...
struct qt_meta_stringdata_CLASSNavigationBarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSNavigationBarENDCLASS = QtMocHelpers::stringData(
    "NavigationBar",
    "tabClicked",
    "",
    "index",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNavigationBarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject NavigationBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSNavigationBarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNavigationBarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNavigationBarENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void NavigationBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tabClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->onTabButtonClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &NavigationBar::tabClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *NavigationBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNavigationBarENDCLASS.stringdata0))
...
// SIGNAL 0
void NavigationBar::tabClicked(int _t1)
{
...
constexpr auto qt_meta_stringdata_CLASSmachineENDCLASS = QtMocHelpers::stringData(
    ...
    "on_btnEnregistrerParc_clicked",
    "on_btnAnnulerParc_clicked"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
#endif // !QT_MOC_HAS_STRINGDATA
...
Q_CONSTINIT const QMetaObject machine::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmachineENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onNavigationTabClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'onAjouterButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnEnregistrerParc_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnAnnulerParc_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void machine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onNavigationTabClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->onAjouterButtonClicked(); break;
        case 5: _t->on_btnEnregistrerParc_clicked(); break;
        case 6: _t->on_btnAnnulerParc_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &machine::backToMenu; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
