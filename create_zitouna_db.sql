...
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER PWD_RESET_BI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER EMPLOYEES_BI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER AUDIT_LOG_BI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE PASSWORD_RESET_REQUESTS CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_PWD_RESET'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
-- =========================================================================
-- PASSWORD RESET REQUESTS (offline workflow) + sequence + trigger
-- =========================================================================
...
-- =========================================================================
-- AUDIT LOG (security events) + sequence + trigger
-- =========================================================================
